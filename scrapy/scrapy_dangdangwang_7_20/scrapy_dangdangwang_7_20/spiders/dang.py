...
from ScrapyDangdangwang_7_20.items import ScrapyDangdangwang720Item
class DangSpider(scrapy.Spider):
    name = 'dang'
    allowed_domains = ['http://category.dangdang.com/cp01.01.12.00.00.00.html']
    start_urls = ['http://category.dangdang.com/cp01.01.12.00.00.00.html']
        ...
        class DangSpider(scrapy.Spider):
            ...
            def parse(self, response):
                ...
                for li in li_list:
                    ...
                    book = ScrapyDangdangwang720Item(src=src, name=name, price=price)
